...
\newenvironment{theorem}[1]{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Theorem \arabic{chapter}.\arabic{theorem}. ({#1})}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{theorem*}{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Theorem \arabic{chapter}.\arabic{theorem}.}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{defi}[1]{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Definition \arabic{chapter}.\arabic{theorem}. ({#1})}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{defi*}{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Definition \arabic{chapter}.\arabic{theorem}.}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{lem}[1]{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Lemma \arabic{chapter}.\arabic{theorem}. ({#1})}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{lem*}[1]{\refstepcounter{theorem}\label{#1}\begin{itembox}[l]{\underline{Lemma \arabic{chapter}.\arabic{theorem}.}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{prop}[1]{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Proposition \arabic{chapter}.\arabic{theorem}. ({#1})}}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{prop*}{\refstepcounter{theorem}\begin{itembox}[l]{\underline{Proposition \arabic{chapter}.\arabic{theorem}. }}\vspace{-0.5zh}\ }{\end{itembox}}

\newenvironment{rem}{\refstepcounter{theorem}\begin{flushleft} \underline{Remark \arabic{chapter}.\arabic{theorem}.} \end{flushleft}\vspace{-1zh}\ }{}

\newenvironment{note}{\begin{flushleft} \underline{Notation.} \end{flushleft}\vspace{-1zh}\ }{}

\newenvironment{eg}[1]{\refstepcounter{theorem}\begin{flushleft} \underline{Exempli gratia \arabic{chapter}.\arabic{theorem}. ({#1})} \end{flushleft}\vspace{-1zh}\ }{}
...
\begin{rem}
    \(X\) がパラコンパクト多様体であるとき, 同様の方法で連結準同型 \(\delta^n \colon H^n(X,\mathscr{H}) \to H^{n+1}(X,\mathscr{F})\) が定まり, 次の系列は完全系列となる:
    \begin{align*}
...
\begin{theorem}{Serre双対性}
    留数写像
    \[
        \textrm{res}\colon H^1(X,\Omega_X^1) \to \mathbb{C};\alpha \mapsto \frac{1}{2\pi \sqrt{-1}} \iint _X \beta,\ \delta^0(\beta)=\alpha
    \]
    とカップ積
    \[
...
\begin{theorem}{消滅定理}
    ...
    \begin{enumerate}
        \item \(\deg E <  \Rightarrow h^0(\mathcal{O}_X(E))=0\)
...
\[
    \dim_\mathbb{C} \mathcal{L}_X(D) - \dim_\mathbb{C} \mathfrak{J}_X(D) = 1-g+\deg D
\]
\end{document}